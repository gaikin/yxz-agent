import type { DcfToPopupEvent, PopupScheduleExecutionOverviewUpdatedEvent } from "../../types/frontendProtocol"
...
export class PopupEventPublisher implements PopupEventPublisherContract, PendingExecutionNotifier {
  ...
  async notify(overview: import("../../types/frontendProtocol").ScheduleExecutionOverview): Promise<void> {
    const event: PopupScheduleExecutionOverviewUpdatedEvent = {
      type: "SCHEDULE_EXECUTION_OVERVIEW_UPDATED",
      deviceId: this.deviceId,
      overview,
