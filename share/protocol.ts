...
export type KaiyangStatus =
  ...
  | "reconnecting"
  | "degraded"
export type KaiyangAuthorizationStatus =
  | "unauthorized"
  | "authorizing"
  | "authorized"
  | "expired"
  | "failed"
export type KaiyangEventHookStatus =
  | "unsubscribed"
  | "subscribing"
  | "subscribed"
  | "failed"
...
export interface ScheduleSummary {
  ...
  timezone?: string
  nextTriggerAt?: DateTimeString
  lastTriggeredAt?: DateTimeString
  lastCompletedAt?: DateTimeString
...
export interface FrontendTriggerScheduleEvent {
